...
* 环境依赖
 ...
 ## Model说明
 脚本`Image2Text.py`内包含了用于训练的Image2Text模型和用于快速推断的FastDecoder, 这时你可以从[paddlenlp](https://paddlenlp.readthedocs.io/zh/latest/model_zoo/transformers.html)的模型库中加载各种基于中文数据集的预训练transformer模型.
